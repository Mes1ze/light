...
function light_scripts() {
	wp_enqueue_style( 'light-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'light-style', 'rtl', 'replace' );

	wp_enqueue_script( 'light-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
